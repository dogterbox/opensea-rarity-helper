...
const styles = {
  ...
  rank: 'font-family: "Poppins", sans-serif; position: absolute; bottom: 20px; left: 12px; color: #000; font-weight: 500; font-size: 11px',
  rarity:
    'font-family: "Poppins", sans-serif; position: absolute; bottom: 6px; left: 12px; color: #000; font-weight: 500; font-size: 11px',
};
